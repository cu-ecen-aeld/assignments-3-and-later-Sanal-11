...
CPU: 0 PID: 162 Comm: sh Tainted: G           O       6.1.44 #1
...
x20: 000000556038d990 x19: ffffff8001be6900 x18: 0000000000000000
...
* The crash happened at offset 0x10 into faulty_write. The dereference is of a NULL pointer (0x0).
```
